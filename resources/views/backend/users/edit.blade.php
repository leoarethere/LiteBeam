<x-dashboard-layout>
    ...
    <div class="pb-6">
        <div class="flex flex-col md:flex-row md:justify-between md:items-start gap-4 mb-8 pt-2">
            <div>
                <h1 class="text-2xl lg:text-3xl font-bold text-gray-900 dark:text-white">Edit Akun Admin</h1>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 p-6">
            <form action="{{ route('dashboard.users.update', $user) }}" method="POST">
                ...
                <div class="flex items-center justify-end gap-3 pt-4 border-t dark:border-gray-700">
                    ...
                    <button type="submit" class="px-5 py-2.5 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 transition-colors">Simpan Perubahan</button>
                </div>
            </form>
        </div>
    </div>
