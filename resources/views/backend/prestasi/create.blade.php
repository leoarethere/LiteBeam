        ...
        <div class="flex flex-col md:flex-row md:justify-between md:items-start gap-4 mb-8 pt-2">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    Tambahkan pencapaian atau penghargaan baru instansi.
                </p>
            </div>
        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="title" value="{{ old('title') }}" 
                                ...
                                placeholder="Contoh: Juara 1 Lomba Video Kreatif Tingkat Nasional" required autofocus>
                        ...
                        <div>
                            ...
                            <input type="text" name="award_name" value="{{ old('award_name') }}" 
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" 
                                placeholder="Contoh: Piala Gubernur DIY" required>
                        ...
                        <div>
                            ...
                            <select name="category" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                <option value="Lokal" {{ old('category') == 'Lokal' ? 'selected' : '' }}>Lokal / Daerah</option>
                        ...
                        <div>
                            ...
                            <input type="text" name="type" value="{{ old('type') }}" 
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" 
                                required placeholder="Contoh: Juara 1 / Medali Emas">
