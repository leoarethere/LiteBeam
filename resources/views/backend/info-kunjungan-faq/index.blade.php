<x-dashboard-layout>
    <x-slot:title>Kelola FAQ Kunjungan</x-slot:title>
        ...
        <div class="flex flex-col md:flex-row md:justify-between md:items-start gap-4 mb-8 pt-2">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    Kelola daftar pertanyaan umum seputar kunjungan tamu.
                </p>
            </div>
            
            <a href="{{ route('dashboard.info-kunjungan-faq.create') }}" 
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                            ...
                            <td class="px-6 py-4 text-center">
                                <div class="flex items-center justify-center gap-3">
                                    {{-- Edit --}}
                                    <a href="{{ route('dashboard.info-kunjungan-faq.edit', $faq->id) }}" 
                                       class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
                                        Edit
                                    </a>
                                    
                                    {{-- Hapus --}}
                                    <form action="{{ route('dashboard.info-kunjungan-faq.destroy', $faq->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus FAQ ini?');">
                                        @csrf
                                        @method('DELETE')
                            ...
                            <td colspan="4" class="px-6 py-12 text-center text-gray-500 dark:text-gray-400">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1 max-w-sm">
                                        Tambahkan pertanyaan umum seputar kunjungan.
                                    </p>
                                    <a href="{{ route('dashboard.info-kunjungan-faq.create') }}" class="mt-4 text-blue-600 hover:underline text-sm font-medium">
                                        Tambah Data Pertama
                                    </a>
                                </div>
                            </td>
