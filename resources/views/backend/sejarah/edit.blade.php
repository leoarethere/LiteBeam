<x-dashboard-layout>
    <x-slot:title>Edit Data Sejarah</x-slot:title>
    ...
    <div class="pb-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 overflow-hidden">
            <form action="{{ route('dashboard.sejarah.update', $history) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="title" id="title" value="{{ old('title', $history->title) }}" 
                    ...
                    {{-- Gambar Ilustrasi --}}
                    <div x-data="{ 
                        preview: '{{ $history->image ? Storage::url($history->image) : null }}',
                        handleFile(event) {
                        ...
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Pilih gambar baru untuk mengganti yang lama (Max 5MB)</p>
                    ...
                    <div>
                        ...
                        <input id="content" type="hidden" name="content" value="{{ old('content', $history->content) }}">
                        <trix-editor input="content" class="trix-content bg-gray-50 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white min-h-[250px]"></trix-editor>
