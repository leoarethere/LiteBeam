        ...
        <div class="flex flex-col md:flex-row md:justify-between md:items-start gap-4 mb-8 pt-2">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    Tambahkan informasi publik baru ke PPID.
                </p>
            </div>
        </div>
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Masukkan link lengkap (Google Drive / Dropbox / Website).</p>
                            @error('source_link') <p class="mt-2 text-sm text-red-600 dark:text-red-500">{{ $message }}</p> @enderror
                        </div>

                        {{-- Cover Image (Alpine Preview) --}}
                        <div x-data="{ 
                            preview: null,
                            handleFile(event) {
