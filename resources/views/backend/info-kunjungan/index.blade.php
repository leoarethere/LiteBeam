<x-dashboard-layout>
    ...
    class="pb-6">
        ...
        <div class="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-6 pt-2">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    Kelola informasi terkait jadwal, aturan, dan tata cara kunjungan.
                </p>
            </div>
            
            <a href="{{ route('dashboard.info-kunjungan.create') }}" 
        ...
        <form method="GET" action="{{ route('dashboard.info-kunjungan.index') }}" class="mb-6">
            <div class="flex flex-col md:flex-row gap-4">
                ...
                <div class="flex gap-2">
                    ...
                    @if(request()->hasAny(['search', 'sort']))
                        <a href="{{ route('dashboard.info-kunjungan.index') }}" class="w-full md:w-auto px-5 py-3 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-600 dark:hover:bg-gray-600 text-center">Reset</a>
                    @endif
                </div>
            </div>
        </form>
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-300">
                        <tr>
                            ...
                            <th scope="col" class="px-4 py-3 min-w-[200px]">Judul & Link</th>
                            ...
                            <tr class="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                                ...
                                <td class="px-4 py-4 text-center">
                                    <div class="flex items-center justify-center gap-2">
                                        <a href="{{ route('dashboard.info-kunjungan.edit', $item->id) }}" 
                            ...
                            <tr>
                                <td colspan="6" class="px-6 py-12 text-center text-gray-500 dark:text-gray-400">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <p class="text-base font-medium">Belum ada informasi kunjungan</p>
                                        <p class="text-sm mt-1">Silakan tambahkan informasi baru.</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
        ...
        <div x-show="deleteModal" 
            ...
            <div class="relative bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-md w-full overflow-hidden" @click.away="closeDeleteModal()">
                ...
                <div class="flex items-center justify-end gap-3 p-4 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50">
                    ...
                    <form :action="`{{ route('dashboard.info-kunjungan.destroy', '') }}/${deleteItemId}`" method="POST">
                        @csrf
                        @method('DELETE')
