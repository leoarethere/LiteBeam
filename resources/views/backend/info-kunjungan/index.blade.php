            ...
            <div class="flex flex-col md:flex-row gap-4">
                ...
                <div class="flex gap-2">
                    ...
                    @if(request()->hasAny(['search', 'sort']))
                        <a href="{{ route('dashboard.info-kunjungan.index') }}" class="w-full md:w-auto px-5 py-3 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-600 dark:hover:bg-gray-600">Reset</a>
                    @endif
                </div>
            </div>
        </form>
                        ...
                        <tr>
                            <td colspan="6" class="px-6 py-16 text-center">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <p class="text-lg font-medium text-gray-500 dark:text-gray-400">Tidak ada informasi kunjungan</p>
        ...
        <div x-show="deleteModal" 
            ...
            <div class="relative bg-white rounded-lg shadow-xl dark:bg-gray-800 max-w-md w-full" @click.away="closeDeleteModal()">
                ...
                <div class="flex items-center justify-end gap-3 p-6 border-t dark:border-gray-700">
                    ...
                    <form :action="`{{ route('dashboard.info-kunjungan.destroy', '') }}/${deleteItemId}`" method="POST" class="inline">
                        @csrf
                        @method('DELETE')
