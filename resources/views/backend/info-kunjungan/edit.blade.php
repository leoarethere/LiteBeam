<x-dashboard-layout>
    <x-slot:title>Edit Informasi Kunjungan</x-slot:title>
    ...
    <div class="pb-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 overflow-hidden">
            <form action="{{ route('dashboard.info-kunjungan.update', $infoKunjungan->id) }}" method="POST" enctype="multipart/form-data" novalidate>
                @csrf
                @method('PUT')
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="title" value="{{ old('title', $infoKunjungan->title) }}" 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                Link File / Sumber <span class="text-red-500">*</span>
                            </label>
                            <input type="url" name="source_link" value="{{ old('source_link', $infoKunjungan->source_link) }}" 
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" required>
                            
                            @if($infoKunjungan->source_link)
                                <div class="mt-2 text-xs text-blue-600 dark:text-blue-400">
                                    Link saat ini: <a href="{{ $infoKunjungan->source_link }}" target="_blank" class="underline hover:text-blue-800 dark:hover:text-blue-300">Buka Link</a>
                                </div>
                            @endif
                        ...
                        <div x-data="{ 
                            preview: '{{ $infoKunjungan->cover_image ? Storage::url($infoKunjungan->cover_image) : null }}',
                            handleFile(event) {
                    ...
                    <div>
                        ...
                        <input id="description" type="hidden" name="description" value="{{ old('description', $infoKunjungan->description) }}">
                        <trix-editor input="description" class="trix-content bg-gray-50 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white overflow-x-auto"></trix-editor>
                    ...
                    <div class="flex items-center">
                        <label class="relative inline-flex items-center cursor-pointer">
                            ...
                            <input type="checkbox" name="is_active" value="1" class="sr-only peer" {{ old('is_active', $infoKunjungan->is_active) ? 'checked' : '' }}>
                ...
                <div class="flex items-center justify-between p-6 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700/50 rounded-b-lg">
                    <a href="{{ route('dashboard.info-kunjungan.index') }}" class="px-5 py-2.5 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-600 dark:hover:bg-gray-600 transition-colors">Batal</a>
