<x-dashboard-layout>
    ...
    <div class="pb-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 overflow-hidden">
            <form action="{{ route('dashboard.info-kunjungan.update', $infoKunjungan->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        {{-- Cover Image --}}
                        <div x-data="{ preview: '{{ $infoKunjungan->cover_image ? Storage::url($infoKunjungan->cover_image) : null }}' }">
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                    ...
                    <div class="flex items-center">
                        <label class="inline-flex items-center cursor-pointer">
                            <input type="checkbox" name="is_active" class="sr-only peer" {{ old('is_active', $infoKunjungan->is_active) ? 'checked' : '' }}>
