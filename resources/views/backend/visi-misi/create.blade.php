<x-dashboard-layout>
    ...
    {{-- Style Trix (Sama seperti sebelumnya) --}}
    ...
    <div class="pb-6">
        <div class="flex flex-col md:flex-row md:justify-between md:items-start gap-4 mb-8 pt-2">
            <div>
                <h1 class="text-2xl lg:text-3xl font-bold text-gray-900 dark:text-white">Tambah Data Baru</h1>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Tambahkan Visi atau poin Misi baru.</p>
            </div>
        </div>
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <select name="type" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            <option value="misi">Misi (Poin)</option>
                            <option value="visi">Visi (Utama)</option>
                        </select>
                    </div>

                    {{-- [BARU] Input Gambar dengan Preview --}}
                    <div x-data="{ preview: null }">
                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Gambar / Ikon (Opsional)</label>
                        
                        <div class="mb-3" x-show="preview" style="display: none;">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="number" name="order" value="1" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
