<x-dashboard-layout>
    <x-slot:title>Manajemen Visi & Misi</x-slot:title>
    ...
    class="pb-6">
        ...
        <div class="flex flex-col md:flex-row md:justify-between md:items-start gap-4 mb-8 pt-2">
            <div>
                <h1 class="text-2xl lg:text-3xl font-bold text-gray-900 dark:text-white">Visi & Misi</h1>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Kelola visi dan poin-poin misi perusahaan.</p>
            </div>
            <a href="{{ route('dashboard.visi-misi.create') }}" 
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-300">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-center w-36">Aksi</th> {{-- Lebar kolom aksi disesuaikan --}}
                        </tr>
                    </thead>
                        ...
                        @forelse ($visiMisis as $item)
                            <tr class="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                                ...
                                <td class="px-6 py-4 text-center">
                                    @if($item->image)
                                        <img src="{{ Storage::url($item->image) }}" alt="Img" class="h-10 w-10 rounded-md object-cover mx-auto border border-gray-200 dark:border-gray-600">
                                    @else
                                ...
                                <td class="px-6 py-4 text-center">
                                    @if($item->type == 'visi')
                                        <span class="bg-purple-100 text-purple-800 text-xs font-medium px-2.5 py-0.5 rounded dark:bg-purple-900 dark:text-purple-300 uppercase tracking-wide border border-purple-200 dark:border-purple-800">Visi</span>
                                    @else
                                        <span class="bg-blue-100 text-blue-800 text-xs font-medium px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300 uppercase tracking-wide border border-blue-200 dark:border-blue-800">Misi</span>
                                    @endif
                                </td>
                                <td class="px-6 py-4">
                                ...
                                {{-- [PERBAIKAN] Tombol Aksi yang Konsisten --}}
                                <td class="px-6 py-4 text-center">
                            ...
                            <tr>
                                <td colspan="6" class="px-6 py-12 text-center text-gray-500 dark:text-gray-400">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <p class="text-base font-medium">Belum ada data Visi/Misi</p>
        ...
        <div x-show="deleteModal" 
            ...
            <div class="relative bg-white rounded-lg shadow-xl dark:bg-gray-800 max-w-md w-full" 
                ...
                <div class="flex items-center justify-end gap-3 p-6 border-t dark:border-gray-700">
                    ...
                    {{-- Form Action Dynamic --}}
                    <form :action="`{{ route('dashboard.visi-misi.destroy', '') }}/${deleteItemId}`" method="POST" class="inline">
                        @csrf
                        @method('DELETE')
