        ...
        <div class="flex flex-col md:flex-row md:justify-between md:items-start gap-4 mb-8 pt-2">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    Perbarui informasi Tugas atau Fungsi.
                </p>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 overflow-hidden">
            <form action="{{ route('dashboard.tugas-fungsi.update', $tugasFungsi->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <select name="type" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white" required>
                            <option value="tugas" @selected(old('type', $tugasFungsi->type) == 'tugas')>Tugas</option>
                            <option value="fungsi" @selected(old('type', $tugasFungsi->type) == 'fungsi')>Fungsi</option>
                        </select>
                    ...
                    <div x-data="{ 
                        preview: '{{ $tugasFungsi->image ? Storage::url($tugasFungsi->image) : null }}',
                        handleFile(event) {
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="flex items-center pt-8">
                            <label class="relative inline-flex items-center cursor-pointer">
                                ...
                                <input type="checkbox" name="is_active" value="1" class="sr-only peer" @checked(old('is_active', $tugasFungsi->is_active))>
                ...
                <div class="flex items-center justify-between p-6 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700/50 rounded-b-lg">
                    <a href="{{ route('dashboard.tugas-fungsi.index') }}" class="px-5 py-2.5 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-600 dark:hover:bg-gray-600 transition-colors">
                        Batal
                    </a>
