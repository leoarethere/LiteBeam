<x-dashboard-layout>
    <x-slot:title>Tambah Himne TVRI</x-slot:title>
        ...
        <div class="flex flex-col md:flex-row md:justify-between md:items-start gap-4 mb-8 pt-2">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    Tambahkan lagu, mars, atau himne baru ke koleksi.
                </p>
            </div>
        </div>

        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 overflow-hidden">
            <form action="{{ route('dashboard.hymne-tvri.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="title" value="{{ old('title') }}" 
                                ...
                                placeholder="Contoh: Himne TVRI" required autofocus>
                        ...
                        <div>
                            ...
                            <input type="text" name="info" value="{{ old('info') }}" 
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" 
                                placeholder="Contoh: Ciptaan S. Darsiman">
                    ...
                    <div>
                        ...
                        <trix-editor input="synopsis" class="trix-content bg-white dark:bg-gray-700 dark:text-white border-gray-300 dark:border-gray-600 rounded-lg p-2" placeholder="Tulis lirik atau keterangan lagu di sini..."></trix-editor>
