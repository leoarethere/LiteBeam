<x-dashboard-layout>
    ...
    <div class="pb-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 overflow-hidden">
            <form action="{{ route('dashboard.hymne-tvri.update', $hymneTvri->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="title" value="{{ old('title', $hymneTvri->title) }}" 
                        ...
                        <div>
                            ...
                            <input type="text" name="info" value="{{ old('info', $hymneTvri->info) }}" 
                        ...
                        <div>
                            ...
                            <input type="url" name="link" value="{{ old('link', $hymneTvri->link) }}" 
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white">
                    ...
                    <div>
                        ...
                        <trix-editor input="synopsis" class="trix-content bg-white dark:bg-gray-700 dark:text-white border-gray-300 dark:border-gray-600 rounded-lg p-2"></trix-editor>
                        @error('synopsis') <p class="mt-2 text-sm text-red-600 dark:text-red-500">{{ $message }}</p> @enderror
                    </div>

                    {{-- Poster --}}
                    <div x-data="{ preview: '{{ $hymneTvri->poster ? Storage::url($hymneTvri->poster) : null }}' }">
                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                        ...
                        <input type="file" name="poster" x-ref="fileInput" @change="preview = URL.createObjectURL($event.target.files[0])" 
                    ...
                    <div>
                        <label class="inline-flex items-center cursor-pointer">
                            <input type="checkbox" name="is_active" class="sr-only peer" {{ old('is_active', $hymneTvri->is_active) ? 'checked' : '' }}>
                ...
                <div class="flex items-center justify-between p-6 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700/50 rounded-b-lg">
                    <a href="{{ route('dashboard.hymne-tvri.index') }}" class="px-5 py-2.5 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-600 dark:hover:bg-gray-600 transition-colors">Batal</a>
