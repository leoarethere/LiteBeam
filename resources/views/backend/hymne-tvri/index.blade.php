        ...
        <div class="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-6 pt-2">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    Kelola lagu identitas, mars, dan himne stasiun.
                </p>
            </div>
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-300">
                        <tr>
                            ...
                            <th scope="col" class="px-4 py-3 min-w-[200px]">Judul & Info</th>
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        @forelse ($hymnes as $item)
                            <tr class="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                                ...
                                <td class="px-4 py-4">
                                    <div class="space-y-1">
                                        <p class="text-base font-semibold text-gray-900 dark:text-white">{{ $item->title }}</p>
                                        ...
                                        @if($item->link)
                                            <a href="{{ $item->link }}" target="_blank" class="inline-flex items-center gap-1 text-xs font-medium text-blue-600 dark:text-blue-400 hover:underline mt-1">
                            ...
                            <tr>
                                <td colspan="5" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <p class="text-gray-500 dark:text-gray-400 text-base font-medium">Belum ada data Himne</p>
                                        <p class="text-sm text-gray-400 dark:text-gray-500 mt-1">Silakan tambahkan data baru.</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
            ...
            @if($hymnes->hasPages())
                <div class="mt-10 mb-12 px-2 sm:px-0">
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-4">
                        ...
                        {{ $hymnes->withQueryString()->links('vendor.pagination.tailwind') }}
                    </div>
                </div>
            @endif
        </div>
        ...
        <div x-show="deleteModal" 
            ...
            <div class="relative bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-md w-full overflow-hidden" @click.away="closeDeleteModal()">
                ...
                <div class="flex items-center justify-end gap-3 p-4 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50">
                    ...
                    <form :action="`{{ route('dashboard.hymne-tvri.destroy', '') }}/${deleteItemId}`" method="POST">
                        @csrf
                        @method('DELETE')
