            ...
            <form action="{{ route('dashboard.reformasi-rb.update', $reformasiRb->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        {{-- Cover Image --}}
                        <div x-data="{ preview: '{{ $reformasiRb->cover_image ? Storage::url($reformasiRb->cover_image) : null }}' }">
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                Cover RB (Opsional)
                            </label>
                    ...
                    <div class="flex items-center">
                        <label class="inline-flex items-center cursor-pointer">
                            <input type="checkbox" name="is_active" class="sr-only peer" {{ old('is_active', $reformasiRb->is_active) ? 'checked' : '' }}>
