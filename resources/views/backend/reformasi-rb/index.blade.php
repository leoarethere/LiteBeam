            ...
            <div class="flex flex-col md:flex-row gap-4">
                ...
                <div class="flex gap-2">
                    ...
                    @if(request()->hasAny(['search', 'sort']))
                        <a href="{{ route('dashboard.reformasi-rb.index') }}" class="w-full md:w-auto px-5 py-3 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-600 dark:hover:bg-gray-600">Reset</a>
                    @endif
                </div>
            </div>
        </form>
            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-300">
                    <tr>
                        ...
                        <th scope="col" class="px-4 py-4 text-left">Judul & Link File</th>
                                ...
                                <div class="flex items-center justify-center gap-3">
                                    <a href="{{ route('dashboard.reformasi-rb.edit', $item->id) }}" 
                                       class="inline-flex items-center justify-center w-10 h-10 text-xs font-medium 
                                              ...
                                              transition-colors group" title="Edit Data">
                                    ...
                                    <button @click="openDeleteModal({{ $item->id }}, '{{ addslashes($item->title) }}')"
                                        ...
                                        class="inline-flex items-center justify-center w-10 h-10 text-xs font-medium 
                                               ...
                                               transition-colors group" title="Hapus Data">
                                        <svg class="w-4 h-4 group-hover:scale-110 transition-transform" 
                                             fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                        ...
                        <tr>
                            <td colspan="6" class="px-6 py-16 text-center">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <p class="text-lg font-medium text-gray-500 dark:text-gray-400">Tidak ada data ditemukan</p>
                                    <p class="text-sm text-gray-400 dark:text-gray-500 mt-1">Silakan tambahkan data Reformasi RB baru</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
        ...
        <div x-show="deleteModal" 
            ...
            <div class="relative bg-white rounded-lg shadow-xl dark:bg-gray-800 max-w-md w-full" @click.away="closeDeleteModal()">
                ...
                <div class="flex items-center justify-end gap-3 p-6 border-t dark:border-gray-700">
                    ...
                    <form :action="`{{ route('dashboard.reformasi-rb.destroy', '') }}/${deleteItemId}`" method="POST" class="inline">
                        @csrf
                        @method('DELETE')
