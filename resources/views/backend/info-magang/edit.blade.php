<x-dashboard-layout>
    ...
    <div class="pb-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 overflow-hidden">
            <form action="{{ route('dashboard.info-magang.update', $infoMagang->id) }}" method="POST" enctype="multipart/form-data" novalidate>
                @csrf
                @method('PUT')
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="title" id="title" value="{{ old('title', $infoMagang->title) }}" 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            @endif
                            <input type="url" name="source_link" id="source_link" value="{{ old('source_link', $infoMagang->source_link) }}" 
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" required>
                        ...
                        {{-- Cover Image --}}
                        <div x-data="{ 
                            preview: '{{ $infoMagang->cover_image ? Storage::url($infoMagang->cover_image) : null }}',
                            handleFile(event) {
                    ...
                    <div class="flex items-center">
                        <label class="relative inline-flex items-center cursor-pointer">
                            ...
                            <input type="checkbox" name="is_active" value="1" class="sr-only peer" {{ old('is_active', $infoMagang->is_active) ? 'checked' : '' }}>
