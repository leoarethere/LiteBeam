            ...
            <div class="flex flex-col md:flex-row gap-4">
                ...
                <div class="flex gap-2">
                    ...
                    @if(request()->hasAny(['search', 'sort']))
                        <a href="{{ route('dashboard.info-magang.index') }}" class="w-full md:w-auto px-5 py-3 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-600 dark:hover:bg-gray-600 text-center transition-colors">Reset</a>
                    @endif
                </div>
            </div>
        </form>
                            ...
                            <tr>
                                <td colspan="6" class="px-6 py-12 text-center text-gray-500 dark:text-gray-400">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <p class="text-base font-medium">Belum ada informasi magang</p>
        ...
        <div x-show="deleteModal" 
            ...
            <div class="relative bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-md w-full overflow-hidden" @click.away="closeDeleteModal()">
                ...
                <div class="flex items-center justify-end gap-3 p-4 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50">
                    ...
                    <form :action="`{{ route('dashboard.info-magang.destroy', '') }}/${deleteItemId}`" method="POST">
                        @csrf
                        @method('DELETE')
