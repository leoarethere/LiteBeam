<x-dashboard-layout>
    <x-slot:title>Tambah Informasi Magang</x-slot:title>
        ...
        <div class="flex flex-col md:flex-row md:justify-between md:items-start gap-4 mb-8 pt-2">
            <div>
                <h1 class="text-2xl lg:text-3xl font-bold text-gray-900 dark:text-white">
                    Buat Info Magang Baru
                </h1>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    Tambahkan informasi magang atau PKL baru.
                </p>
            </div>
        </div>

        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 overflow-hidden">
            <form action="{{ route('dashboard.info-magang.store') }}" method="POST" enctype="multipart/form-data" novalidate>
                @csrf
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="title" id="title" value="{{ old('title') }}" 
                            ...
                            placeholder="Contoh: Penerimaan Mahasiswa Magang Periode 2024" required>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="url" name="source_link" id="source_link" value="{{ old('source_link') }}" 
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" 
                                placeholder="https://..." required>
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Masukkan link lengkap (Formulir / PDF / Website).</p>
