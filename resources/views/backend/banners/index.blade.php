<x-dashboard-layout>
    ...
    <div x-data="{ 
        ...
        // Fungsi untuk membuka modal dengan safety check
        ...
        // Fungsi untuk menutup modal dengan safety check  
        closeDeleteModal() {
    ...
    x-init="
        // Pastikan modal tertutup saat komponen diinisialisasi
        deleteModal = false;
        deleteBannerId = null;
        deleteBannerTitle = '';
    "
    class="pb-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            @forelse ($banners as $banner)
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 flex flex-col hover:shadow-lg transition-shadow duration-200">
                    {{-- Gambar Banner --}}
