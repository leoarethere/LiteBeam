<footer class="bg-gray-900 dark:bg-gray-950 border-t border-white/10">
    {{-- 
        ============================================================
        PERBAIKAN UTAMA ADA DI SINI
        ============================================================
        Div ini sekarang berfungsi sebagai container, menyatukan semua elemen footer.
        - `max-w-7xl`: Membatasi lebar maksimum.
        - `mx-auto`: Menengahkan container.
        - `px-*` dan `py-*`: Memberikan padding yang konsisten dan responsif.
    --}}
        ...
        <div class="md:flex md:justify-between">
            <div class="mb-6 md:mb-0 max-w-sm">
                <a href="/" class="flex items-center mb-6">
                    ...
                    <span class="self-center text-2xl font-semibold whitespace-nowrap text-white">Media Pemersatu Bangsa</span>
                </a>
