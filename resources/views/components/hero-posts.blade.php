...
>
    ...
    <div class="relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
        <div class="max-w-screen-md">
            <h2 class="mb-4 text-3xl font-bold tracking-tight text-white sm:text-4xl">Apa yang kamu cari?</h2>
            ...
            <form action="{{ route('posts.index') }}" method="GET">
                {{-- Menjaga filter yang sedang aktif --}}
                @if (request('category'))
                ...
                <div class="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                    ...
                    <div>
                        <button type="submit" class="py-4 px-6 w-full text-sm font-medium text-white bg-blue-700 rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 transition-colors sm:ml-2 sm:w-auto">
                            Cari
                        </button>
                    </div>
                </div>
