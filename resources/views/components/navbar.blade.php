...
>
    ...
    <div class="h-10 bg-blue-900 text-white text-xs font-medium relative z-50 border-b border-blue-800">
        <div class="container mx-auto px-4 sm:px-6 xl:px-8 h-full flex justify-between items-center">
            ...
            {{-- Kanan: Sosial Media (Diambil dari Footer) --}}
            <div class="flex items-center gap-3 ml-auto">
                <span class="hidden sm:inline text-white">Hubungi Kami:</span>
                    <div class="flex gap-3">
                <span class="flex gap-3 sm:inline text-white-100">(0274) 514402</span>
                <span> | </span>
                <span class="hidden sm:inline text-white">Ikuti Kami:</span>
                <div class="flex gap-3">
                    <a href="#" class="hover:text-blue-300 transition"><i data-feather="facebook" class="w-4 h-4"></i></a>
                    <a href="#" class="hover:text-blue-300 transition"><i data-feather="twitter" class="w-4 h-4"></i></a>
                    <a href="#" class="hover:text-blue-300 transition"><i data-feather="instagram" class="w-4 h-4"></i></a>
                    <a href="#" class="hover:text-blue-300 transition"><i data-feather="youtube" class="w-4 h-4"></i></a>
                </div>
            </div>
        </div>
    </div>
