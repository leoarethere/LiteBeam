        ...
        <div class="flex-1 overflow-y-auto overflow-x-hidden py-5 px-3 scrollbar-hide">
            ...
            <ul class="space-y-2">
                ...
                <x-sidebar-item href="{{ url('/dashboard') }}" :active="request()->is('dashboard')">
                    <x-slot:icon>
                        <svg class="w-6 h-6 flex-shrink-0 transition-transform duration-200 group-hover:scale-110" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <li class="relative group">
                    <button 
                        ...
                        class="flex items-center w-full p-2 text-base font-medium rounded-lg transition-colors duration-200"
                        :class="{ 
                    ...
                    <ul x-show="dropdowns.publikasi" 
                        ...
                        <li>
                            ...
                            class="flex items-center gap-3 py-2 px-3 text-sm rounded-md transition-colors duration-200"
                            :class="{
