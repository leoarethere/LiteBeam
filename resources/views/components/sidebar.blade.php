<aside 
    ...
    <div class="overflow-y-auto py-5 px-3 h-full">
        <ul class="space-y-2">
            ...
            {{-- Informasi --}}
            <x-sidebar-item href="/info-publikasi" :active="request()->is('info-publikasi*')">
                <x-slot:icon>
                    <svg class="w-6 h-6 flex-shrink-0 transition-transform duration-200 group-hover:scale-110" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
            ...
            {{-- Penyiaran --}}
            <x-sidebar-item href="/penyiaran" :active="request()->is('penyiaran*')">
                <x-slot:icon>
                    <svg class="w-6 h-6 flex-shrink-0 transition-transform duration-200 group-hover:scale-110" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
        ...
        <ul class="space-y-2">
            {{-- Settings (diubah menjadi komponen x-sidebar-item) --}}
            <x-sidebar-item href="/settings" :active="request()->is('settings*')" index="4">
                <x-slot:icon>
