                    ...
                    <div x-show="openDropdown === 'user'"
                        ...
                        <ul class="py-1">
                            <li>
                                ...
                                <a href="#" class="flex items-center gap-2 px-4 py-2 text-sm transition-colors duration-200 text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700">
    ...
    <div x-show="isMobileMenuOpen" 
        ...
        <div class="px-4 pt-4 pb-3">
            ...
            <div class="flex flex-col space-y-2">
                ...
                <a href="#" class="flex items-center gap-3 rounded-lg px-4 py-3 text-base font-medium transition-all duration-200 text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-white">
