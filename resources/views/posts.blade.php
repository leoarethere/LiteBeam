<x-layout>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section 
            ...
            class="relative h-[60vh] md:h-[50vh] overflow-hidden rounded-xl md:rounded-2xl mb-8"
        >
            ...
            <div class="relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
                <div class="max-w-screen-md">
                    <h2 class="mb-4 text-3xl tracking-tight font-extrabold text-white sm:text-4xl">Temukan Wawasan Baru</h2>
