        ...
        <div class="mb-10">
            <form method="GET" action="{{ route('ppid.index') }}" class="max-w-7xl mx-auto">
                <div class="flex flex-col md:flex-row justify-between items-center gap-4 p-4 bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
                        ...
                        {{-- Search Input (Diintegrasikan ke sini) --}}
            ...
            @if(request()->hasAny(['search', 'sort']))
                <div class="max-w-7xl mx-auto mt-4 flex flex-wrap items-center justify-between gap-4 px-2">
                    ...
                    <a href="{{ route('ppid.index') }}" class="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-red-700 bg-red-100 rounded-full hover:bg-red-200 dark:bg-red-900/30 dark:text-red-300 dark:hover:bg-red-900/50 transition-colors">
                ...
                <div class="grid gap-6 grid-cols-1 lg:grid-cols-2">
                    @foreach($ppids as $item)
                        ...
                        <div class="group relative flex flex-col md:flex-row bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                            ...
                            {{-- 1. GAMBAR / ICON (KIRI) --}}
                            {{-- Mobile: Full width (aspect video), Desktop: Fixed width (w-48) --}}
                            ...
                            <div class="flex-1 p-5 flex flex-col justify-between">
                                <div>
                                    ...
                                    <div class="flex items-center justify-between mb-3">
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-md text-[10px] font-bold uppercase tracking-wide bg-green-100 text-green-800 dark:bg-green-900/40 dark:text-green-300 border border-green-200 dark:border-green-800">
                                            PPID
                                        </span>
                                ...
                                <div class="pt-4 border-t border-gray-100 dark:border-gray-700 flex items-center gap-3">
                                    ...
                                    <div x-data="{ 
                                        ...
                                        <button @click="copyToClipboard()" 
                                                class="p-2 text-gray-500 bg-gray-50 hover:bg-gray-100 dark:bg-gray-700/50 dark:text-gray-400 dark:hover:bg-gray-600 rounded-lg transition-colors border border-gray-200 dark:border-gray-600 relative group/tooltip"
            ...
            @else
                ...
                <div class="text-center py-16 bg-white dark:bg-gray-800 rounded-3xl border-2 border-dashed border-gray-200 dark:border-gray-700">
                    ...
                    <p class="text-gray-500 dark:text-gray-400 max-w-md mx-auto mb-8">
                        @if(request('search'))
                            Tidak ada dokumen PPID yang cocok dengan kata kunci <strong>"{{ request('search') }}"</strong>.
                        @else
                            Belum ada dokumen publik yang tersedia saat ini.
                        @endif
                    </p>
                    @if(request('search'))
                        <a href="{{ route('ppid.index') }}" class="inline-flex items-center px-6 py-2.5 text-sm font-medium text-white bg-blue-600 rounded-xl hover:bg-blue-700 transition-colors shadow-sm">
                            Reset Pencarian
                        </a>
                    @endif
                </div>
